...
export const Route = createFileRoute("/admin/almanac/$id")({
...
function RouteComponent() {
  ...
  const { data: almanac, isLoading, error } = useAlmanacQuery(id);
      ...
      <div className="flex items-start justify-between gap-4">
        ...
        <div className="flex shrink-0 gap-2">
          <Button asChild variant="outline">
            <Link to="/admin/almanac/edit/$id" params={{ id }}>
          ...
          <AlertDialog>
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                <AlertDialogTitle>Delete almanac?</AlertDialogTitle>
                <AlertDialogDescription>
                  This will permanently delete "{almanac.title}". This action
                  cannot be undone.
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
        ...
        <div className="space-y-4">
          <InfoCard label="Created">
            <p>{format(almanac.createdAt, "dd MMM yyyy")}</p>
          </InfoCard>

          {almanac.pdf && (
            <InfoCard label="PDF">
              <a
                href={almanac.pdf.url}
                target="_blank"
